...
export default function TermsAndConditions() {
  return (
    <LegalContainer title="Terms and Conditions" lastUpdated="Last Updated: September 22, 2026">
      <p>
        These Terms and Conditions govern your access to and use of the <strong>Our Bloom</strong> mobile application and web portal (<a href="https://our-bloom-gamma.vercel.app" className="text-blue-600 font-medium hover:underline">our-bloom-gamma.vercel.app</a>), operated by <strong>Our Bloom</strong>. By accessing our services, you agree to be bound by these terms.
      </p>

      <h2 className="text-lg font-bold text-[#0F2744] pt-2">1. Purpose &amp; Scope</h2>
      <p>
      ...
      <h2 className="text-lg font-bold text-[#0F2744] pt-2">2. Couple's Savings Vault &amp; Transparent 2% Platform Fee</h2>
      <ul className="list-disc pl-5 space-y-2 text-sm text-slate-700">
        ...
        <li><strong>Verified Gateway Transactions:</strong> Payments are processed via authorized gateway partners (including PayU Payments Pvt. Ltd.). Vault balances are authoritatively credited only upon backend cryptographic signature verification.</li>
      ...
      <h2 className="text-lg font-bold text-[#0F2744] pt-2">3. User Conduct &amp; Account Security</h2>
      <p>
        Users agree not to upload malicious software, submit fake or duplicate UTR numbers, or use the service for unlawful purposes. We reserve the right to suspend accounts that violate platform integrity or engagement rules.
      </p>

      <h2 className="text-lg font-bold text-[#0F2744] pt-2">4. Governing Law &amp; Dispute Resolution</h2>
      <p>
      ...
      <div className="bg-blue-50/60 border-l-4 border-[#2563EB] p-4 rounded-r-xl space-y-1 text-xs">
        <p className="font-bold text-[#0F2744]">Legal &amp; Support Contact:</p>
        <p>Entity: Our Bloom</p>
        <p>Email: <a href="mailto:support@ourbloom.app" className="text-blue-600 font-bold hover:underline">support@ourbloom.app</a></p>
      </div>
    </LegalContainer>
  );
}
