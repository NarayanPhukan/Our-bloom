...
class PayUCheckoutActivity : AppCompatActivity() {
    ...
    private fun setupWebView() {
        ...
        // Allow cookies for banking sessions
    ...
    private fun initiatePayment() {
        ...
        val payuKey = "gejLUv"
        val payuSalt = "VmEuk1TyFepTJ4z8WBcip0vcId520YFi"
        val actionUrl = "https://test.payu.in/_payment"
    ...
    private fun onPaymentApproved() {
        ...
        progressBar.visibility = View.VISIBLE
        Toast.makeText(this, "Payment approved! Adding to Vault... 🌸", Toast.LENGTH_SHORT).show()
        ...
        lifecycleScope.launch {
            ...
            if (success) {
                Toast.makeText(this@PayUCheckoutActivity, "₹${amount.toInt()} added to Our Vault! 🎉", Toast.LENGTH_LONG).show()
